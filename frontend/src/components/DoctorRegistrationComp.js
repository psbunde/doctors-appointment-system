        ...
        switch(name) {
           ...
           /*case 'qualification':
                          ...
                          if(pattern.test(value) )
                            ...
                            {
                                 valid = false;
                                 error = "Please enter valid qualification in Capital letters"
                            }     
                            break;
          ...
          */
            case 'pincode':
                              ...
                              if(pattern.test(value) )
                                ...
                                {
                                     valid = false;
                                     error = "Please enter valid pincode in 6 numbers";
                                }     
                                break;
    ...
    <div className="doc">
        ...
        <form action="">
            ...
            <div class="mb-3">
                ...
                <select style={{width:200}}  onChange={(e)=>dispatch({type: 'update', data: {name:"qualification",value:e.target.value,touched: true, valid:true, error:"",formvalid:true} })}>
               ...
               {/*  <input type="text" class="form-control" id="qualification" placeholder="Enter qualification" name="qualification" value={info.qualification.value}
                 ...
                 <div className="error-msg"> {info.qualification.error}</div>
            </div> */}


            <div class="mb-3">
                <label for="experience" class="form-label">Experience:</label>
                <input type="number" class="form-control" id="email" placeholder="Enter experience..."  name="experience" value={info.experience.value}
                 
                 onChange={(e)=>handleChange("experience",e.target.value)}/>
                 <div className="error-msg"> {info.experience.error}</div> 
            </div>

           {/* {<div class="mb-3">
                <label for="specialization" class="form-label">Specialization :</label>
                <select style={{width:200}}  onChange={(e)=>dispatch({type: 'update', data: {name:"specialization",value:e.target.value,touched: true, valid:true, error:"",formvalid:true} })}>
            ...
            <div class="mb-3">
                ...
                <select style={{width:200}}  onChange={(e)=>dispatch({type: 'update', data: {name:"department",value:e.target.value,touched: true, valid:true, error:"",formvalid:true} })}>
                        <option value="select">Select</option>
                        <option value="Cardiology">Cardiology</option>
          ...
          {/*  <div class="mb-3">
            ...
            <div class="mb-3">
                <label class="form-label" for="Doctor Type"> Doctor Type :- </label>
                <input class="form-check-input" type="radio" name="docType" id="docType" value="Regular"
                   onChange={(e)=>dispatch({type: 'update', data: {name:"docType",value:e.target.value,touched: true, valid:true, error:"",formvalid:true} })}/> Regular
                
                <input class="form-check-input" type="radio" name="docType" id="docType" value="Visiting"
                    onChange={(e)=>dispatch({type: 'update', data: {name:"docType",value:e.target.value,touched: true, valid:true, error:"",formvalid:true} })}/> Visiting
            ...
            */}
            ...
            <div class="mb-3">
                ...
                <select style={{width:300}} class="form-control" id="City" name="City"   
                 onChange={(e)=>dispatch({type: 'update', data: {name:"City",value:e.target.value,touched: true, valid:true, error:"",formvalid:true} })} >
