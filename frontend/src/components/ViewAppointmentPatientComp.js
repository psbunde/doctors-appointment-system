                           ...
                           Appointment.map((app)=>{
                               ...
                               return(
                                <tr>
                                    ...
                                    <td> 
                                        <button type="submit" className="btn btn-danger" disabled={app.status==="SCHD"?false:true} onClick={()=>{requestCancellation(app.app_id)}}>Cancel</button>
                                    </td> 
                                    <td> 
                                        {app.status==="CANC_REQ"?<p>Cancellation Requested</p>:app.status==="CANC"?<p>Cancellation Accepted</p>:""}    
                                    </td>   
                                </tr>
